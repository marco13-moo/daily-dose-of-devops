# Daily Dose of DevOps — Telemetry design: during migration programs

# Telemetry design: during migration programs

Scale converts an informal convention into an outage mechanism. For **telemetry design during migration programs**, the decisive question is not whether a team can demonstrate the technology once. It is whether the organisation can operate it repeatedly, audit its decisions, and recover when assumptions fail.
