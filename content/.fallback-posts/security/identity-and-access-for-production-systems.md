# Identity and access: for production systems

Scale converts an informal convention into an outage mechanism. For **identity and access for production systems**, the decisive question is not whether a team can demonstrate the technology once. It is whether the organisation can operate it repeatedly, audit its decisions, and recover when assumptions fail.

## The operating problem

Treat identity and access as part of a zero-trust delivery system in which identity, provenance, and policy are evaluated continuously. Define the consumer, owner, support boundary, change policy, and recovery objective before selecting implementation details. When operating identity and access for production systems, undocumented authority and ambiguous ownership create more risk than a missing feature.
...
- Design for the constraints captured by “for production systems”; document the authority, failure domain, and recovery objective.
